...
public class Mission2_2 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < score.length; i++) {
			System.out.println((i + 1) + "\t" + score[i][0] + "\t" + score[i][1] + "\t" + score[i][2] + "\t" + st[i][0]
					+ "\t" + st[i][1]);
		}
		System.out.println("===========================================================================");
		for (int i = 0; i < 2; i++) {
		...
		System.out.println();
		System.out.print("\t" + korTotal / score3.length);
		System.out.print("\t" + engTotal / score3.length);
		System.out.print("\t" + matTotal / score3.length);
	}
