...
public class RegularExam01 {
	...
	public static void main(String[] args) {
		...
		//abc 문자 포함 여부 체크 : dsf abc fdsfdsa
//		if(str.matches(".*abc.*")) {
...
//			System.out.println("비매칭");
//		}
		//일반 파일 이미지파일 구별 => 대소문자 구분 없이
		//abc.jpg abc.gif abc.PNG, abc.txt S:공백문자X
