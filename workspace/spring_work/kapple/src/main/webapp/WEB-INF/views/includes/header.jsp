	                ...
	                <div class="card position-relative border-0">
	                  ...
	                  <div class="overflow-auto scrollbar" style="height: 10rem;">
	                    <ul class="nav d-flex flex-column mb-2 pb-1">
	                      <li class="nav-item"><a class="nav-link px-3" href="/home"> <span class="me-2 text-900" data-feather="user"></span><span>Profile</span></a></li>
	                  ...
	                  <div class="card-footer">
	                    <div class="my-2"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="/customLogout"> <span class="me-2" data-feather="log-out"> </span>logout</a></div>
...
<%--          <c:if test="${pinfo eq null}">
          	<div class="my-2"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="/customLogin"> <span class="me-2" data-feather="log-in"> </span>login</a></div>
         </c:if> --%>
